...
const Academic = () => (
  <ExperienceCarousel>
    <Carousel.Item>
      ...
      >
        EECS 477 is University of Michigan's upper-level, proof-based algorithms
        course. Topics in the course include amortized analysis, linear
        programming, randomized algorithms, and approximation algorithms.
      </AcademicCard>
    </Carousel.Item>
    <Carousel.Item>
      <AcademicCard
        experienceTitle={
          <a href="https://ioe.engin.umich.edu/" className="experienceTitle">
    ...
    <Carousel.Item>
      ...
      >
        MATH 217 is the first proof-based, rigorous course in the undergraduate
        mathematics curriculum. Kiluk Proof Tutors tutor students on how to
        write proofs in clear and concise mathematical language.
      </AcademicCard>
    </Carousel.Item>
    <Carousel.Item>
      <AcademicCard
      ...
      >
        Students in ENG100 design and launch a high-altitude balloon payload to
        collect weather data. They program an Arduino to interface with sensors,
        design and solder a printed circuit board, and build the payload
        housing.
      </AcademicCard>
    </Carousel.Item>
    <Carousel.Item>
      <AcademicCard
        experienceTitle={
          <a href="https://mdp.engin.umich.edu" className="experienceTitle">
