...
const AboutMe = () => (
    <Card className="bg-dark text-white" style={{ width: "100%" }}>
        <Card.Body>
            ...
            <Card.Text>
                I graduated from the University of Michigan with a degree in Computer Science in December 2019. Starting in February 2020, I will be working at Microsoft.
